...
O sistema SHALL permitir que o lojista configure os horários em que sua loja aceita recebimento de entregas. A janela MUST ter horário de início e horário de fim para cada dia da semana.

#### Scenario: Lojista configura janela de recebimento
- **WHEN** lojista faz POST em `/stores/{id}/receiving-window` com start_time="15:00" e end_time="19:00" para dias úteis
- **THEN** o sistema salva a janela e retorna HTTP 201

#### Scenario: Entrega estimada fora da janela
- **WHEN** uma entrega tem ETA de chegada às 21:00 mas a loja fecha recebimento às 19:00
...
- **WHEN** ETA calculado é 16:30 e janela é 15:00–19:00
- **THEN** o sistema marca entrega como "dentro_da_janela"

#### Scenario: ETA fora da janela após evento de caos
- **WHEN** evento de caos empurra ETA de 18:30 para 20:00 e janela fecha às 19:00
